...
teo_xy_sf$lib_cardio_5km <- etab_moins_de(1000, "D202")
teo_xy_sf$lib_dist_min_cardio <- dist_min("D202")
teo_xy_sf$lib_dermato_5km <- etab_moins_de(1000, "D203")
teo_xy_sf$lib_dist_min_dermato <- dist_min("D203")
teo_xy_sf$lib_gastro_5km <- etab_moins_de(1000, "D206")
teo_xy_sf$lib_dist_min_gastro <- dist_min("D206")
teo_xy_sf$lib_psychiatre_5km <- etab_moins_de(1000, "D207")#il galère parce qu'il y en a beaucoup probablement
teo_xy_sf$lib_dist_min_psychiatre <- dist_min("D207")
teo_xy_sf$lib_ophtalmo_5km <- etab_moins_de(1000, "D208")
teo_xy_sf$lib_dist_min_ophtalmo <- dist_min("D208")
teo_xy_sf$lib_orl_5km <- etab_moins_de(1000, "D209")
teo_xy_sf$lib_dist_min_orl <- dist_min("D209")
teo_xy_sf$lib_ped_5km <- etab_moins_de(1000, "D210")
teo_xy_sf$lib_dist_min_ped <- dist_min("D210")
teo_xy_sf$lib_pneumo_5km <- etab_moins_de(1000, "D211")
teo_xy_sf$lib_dist_min_pneumo <- dist_min("D211")
teo_xy_sf$lib_gynéco_5km <- etab_moins_de(1000, "D214")
teo_xy_sf$lib_dist_min_gynéco <- dist_min("D214")
teo_xy_sf$lib_dent_5km <- etab_moins_de(1000, "D221")
teo_xy_sf$lib_dist_min_dent <- dist_min("D221")
teo_xy_sf$lib_sf_5km <- etab_moins_de(1000, "D231")
teo_xy_sf$lib_dist_min_sf <- dist_min("D231")
teo_xy_sf$lib_psychologue_5km <- etab_moins_de(1000, "D243")
teo_xy_sf$lib_dist_min_psychologue <- dist_min("D243")
teo_xy_sf$lib_labo_5km <- etab_moins_de(1000, "D302")
